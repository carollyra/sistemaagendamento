  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDownIcon className="text-mist-500 size-4" />
...
function SelectLabel({ className, ...props }: React.ComponentProps<typeof SelectPrimitive.Label>) {
  return (
    <SelectPrimitive.Label
      ...
      className={cn('text-mist-500 px-2 py-1.5 text-[11px] tracking-wide uppercase', className)}
      {...props}
    />
  );
}
...
function SelectSeparator({
  ...
  return (
    <SelectPrimitive.Separator
      ...
      className={cn('bg-ink-700 -mx-1 my-1 h-px', className)}
      {...props}
    />
  );
}
...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpButton
      ...
      className={cn(
        'text-mist-500 flex cursor-default items-center justify-center py-1',
        className,
      )}
      {...props}
    >
